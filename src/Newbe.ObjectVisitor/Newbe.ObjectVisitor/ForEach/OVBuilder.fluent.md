...
_ForEachCore1 : ForEachObject(Expression<Action<IObjectVisitorContext<T, object>>> foreachAction)
_ForEachCore2 : ForEachObject(Expression<Action<string, object>> foreachAction)
